...
const About = () => {
  return (
    <div style={{ minHeight: '85.5vh', marginLeft: '1%', marginTop: '1%' }}>
      ...
      <div>
        <button class="btn btn-primary" style={{ width: '245px', textAlign: 'left' }} type="button" disabled>
          <span class="spinner-grow spinner-grow-sm" aria-hidden="true"></span>
          <span role="status">Hi! I am Ayush. Welcome!</span>
        </button>
      </div>
      <button class="btn btn-primary" style={{ marginTop: '1%' }} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
